      ...
      <div className="flex flex-col min-h-screen scroll-smooth">
        ...
        >
          <div className="text-center md:text-left">
            <h1 className="font-Hammersmith-One font-bold text-[24px] md:text-[28px] mb-2 text-[#1F2A44]">
            ...
            <div className="flex flex-col sm:flex-row sm:items-center sm:justify-start">
              <a target="_blank" href={cv} download="cv">
                <button className="p-3 mt-4 rounded-[10px] bg-[#1F2A44] text-white font-Inter hover:opacity-95 transition hover:cursor-pointer">
                  Download CV
                </button>
              </a>
              <Link to="/certifications">
                <button className="p-3 mt-4 rounded-[10px] bg-white shadow-lg text-[#1F2A44] font-Inter hover:opacity-95 transition hover:cursor-pointer">
                  Certifications
                </button>
              </Link>
            </div>
          ...
          <motion.img
            ...
            decoding="async"
            className="w-[250px] md:w-[350px] rounded-full hover:outline hover:outline-2 hover:outline-[#1F2A44]"
            src={portrait}
            alt="Portrait"
          />
        </motion.div>
        ...
        >
          <h1 className="text-2xl font-bold mb-4 text-[#1F2A44] font-Halant">
            About Me
          </h1>
          <p className="text-base leading-relaxed text-gray-700 font-Nunito">
        ...
        >
          ...
          <div className="w-full max-w-[300px] shadow-xl px-5 py-12 rounded-[20px]">
            ...
            <div>
              ...
              <h3 className="font-Open-Sans">Science</h3>
              <h4 className="text-gray-600 text-[14px] font-Roboto">
                July 2020 - May 2023
              </h4>
            </div>
            <br />
            <div>
              ...
              <h3 className="font-Open-Sans">Computer Science</h3>
              <h4 className="text-gray-600 text-[14px] font-Roboto">
          ...
          <div className="w-full max-w-[300px] shadow-xl px-5 py-12 rounded-[20px]">
            ...
            <div>
              ...
              <h3 className="font-Open-Sans">BINUS International University</h3>
              <h4 className="text-gray-600 text-[14px] font-Roboto">
            ...
            <div>
              ...
              <h3 className="font-Open-Sans">Xlerator</h3>
              <h4 className="text-gray-600 text-[14px] font-Roboto">
                July 2025 - Finish
              </h4>
            </div>
        ...
        <motion.div
          ...
          id="projects"
        >
          <h1 className="text-3xl font-bold mb-8 text-center text-[#1F2A44] font-Halant">
            Projects
          </h1>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 place-items-center">
            {[
              ...
              >
                <h3 className="font-Hammersmith-One text-[22px] font-bold text-[#1F2A44] mb-1">
                  {proj.title}
                </h3>
                ...
                <a target="_blank" href={proj.url}>
                  <button className="bg-[#1F2A44] hover:bg-[#2B3C5A] transition-colors text-white px-5 py-2 rounded-[20px] font-Inter hover:cursor-pointer">
                    Visit Project
                  </button>
                </a>
              </motion.div>
        ...
        <motion.div
          ...
          id="contact"
        >
          <h1 className="text-2xl font-bold mb-2 font-Halant text-[#1F2A44]">
            Contact Me
          </h1>

          <h4 className="text-sm text-gray-600 mb-2 flex flex-row font-Roboto">
            <SiGmail className="text-lg mr-[5px]" />
          ...
          <div className="flex flex-col gap-3 justify-center items-start mt-6 text-gray-700 text-sm font-Open-Sans">
            <a
